    ...
    <div class="profile-nav col-md-3">
        <div class="panel">
            <div class="user-heading round">
                ...
                <h1>{{$user->name}}</h1>
                <p>{{$user->email}}</p>
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#armouryModal">Wallet {{$user->wallet_coins}}</button>
            </div>

            {{-- <ul class="list-group">
                <li class="list-group-item"><a href="#"> <i class="fa fa-user"></i> Profile</a></li>
                <li class="list-group-item"><a href="#"> <i class="fa fa-calendar"></i> Recent Activity <span class="label label-warning pull-right r-activity">9</span></a></li>
            ...
            <div class="col-md-3">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="bio-desk">
                            <h4 class="terques">RECENT MATCHES</h4>
                            <p>
                                W W W W W <br/>
                                +20XP  +20XP  +25XP  +25XP  +25XP
                            </p>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="armouryModal" tabindex="-1" role="dialog" aria-labelledby="armouryModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background:#000;">
        <div class="modal-header">
          <h5 class="modal-title" id="armouryModalLabel">Buy credits</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color:#ffff">&times;</span>
          </button>
        </div>
            ...
            <div class="row imagetiles">
                @foreach ($creditplans as $plan)
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                        <img src="{{url('assets/frontend/images/coin.jpeg')}}" class="img-responsive">
                        <p>${{$plan->price}} {{$plan->credits}} credits</p>
                        <button type="button" class="btn btn-danger BuyPlan" data-amount="{{$plan->price}}" >buy</button>
                    </div>
                @endforeach
            </div>
            <div class="row paymentForm" style="display:none">
                <form id="payment-form">
                    <input hidden name="planid">
                    <div id="card-container"></div>
                    <button id="card-button" type="button">Pay $1000</button>
                </form>
...
<script type="text/javascript" src="{{url('assets/frontend/js/payment.js')}}"></script>
<script>
    $( ".BuyPlan" ).click(function() {
        $('.paymentForm').css('display','block');
        $('#card-button').text('Pay $'+$(this).data('amount'));
    });
</script>
