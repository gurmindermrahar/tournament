   ...
   <div class="container-fluid">
      <div class="row mb-2">
         ...
         <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Gears</li>
         </ol>
         </div>
      </div>
   </div>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Gears List</h3>
                  <a style="float:right;" class="btn btn-info" href="{{route('admin.gears.create')}}">Add Gear</a>
               </div>
               <div class="card-body">
