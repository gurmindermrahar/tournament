...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('admin.cashmatches.index')}}">
          <span class="menu-icon">
            <i class="mdi mdi-table-large"></i>
          </span>
          <span class="menu-title">Cash Matches</span>
        </a>
      </li>
      {{-- <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('admin.gears.index')}}">
          <span class="menu-icon">
            <i class="mdi mdi-chart-bar"></i>
          </span>
          <span class="menu-title">Gears</span>
        </a>
      </li> --}}
      <li class="nav-item menu-items">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('admin.credits.index')}}">
          ...
          <span class="menu-title">Credit Plan</span>
        </a>
      </li>
    </ul>
  </nav>
